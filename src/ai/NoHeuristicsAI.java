...
public class NoHeuristicsAI extends Hex {
    ...
    public NoHeuristicsAI(int[][] state, int currentPlayer, int[] lastMove, Map<Integer, Set<Integer>> disjointSets) {
    ...
    public Game copyGame() {
        ...
        Game game = new NoHeuristicsAI(nextState, this.currentPlayer, lastMove, new HashMap<Integer,Set<Integer>>(this.disjointSets));
    ...
    public List<int[]> getSmartMoves() {
        return this.getSmartMoves(false, 0);
    }
    ...
    public Game getNextState(int[] move, boolean changePlayers) {
        ...
        NoHeuristicsAI newGame = new NoHeuristicsAI(nextState, nextPlayer, move, new HashMap<Integer,Set<Integer>>(disjointSets));
