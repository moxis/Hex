...
public class SaveBridgeAI extends Hex {
    ...
    public SaveBridgeAI(int[][] state, int currentPlayer, int[] lastMove, Map<Integer, Set<Integer>> disjointSets) {
    ...
    public Game copyGame() {
        ...
        Game game = new SaveBridgeAI(nextState, this.currentPlayer, lastMove, new HashMap<Integer,Set<Integer>>(this.disjointSets));
    ...
    public Game getNextState(int[] move, boolean changePlayers) {
        ...
        SaveBridgeAI newGame = new SaveBridgeAI(nextState, nextPlayer, move, new HashMap<Integer,Set<Integer>>(disjointSets));
