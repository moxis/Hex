...
public class MonteCarlo {    
    ...
    public ConcurrentHashMap<String, TreeNode> nodes = new ConcurrentHashMap<String, TreeNode>();
    public ConcurrentHashMap<String, TreeNode> bootstrapNodes = new ConcurrentHashMap<String, TreeNode>();
    boolean rave = false;
    ...
    public MonteCarlo(Game game, ConcurrentHashMap bootstrapNodes) {
        this.game = game;
        this.bootstrapNodes = bootstrapNodes;
    }

    public MonteCarlo(Game game, ConcurrentHashMap bootstrapNodes, boolean rave) {
        this.game = game;
        this.bootstrapNodes = bootstrapNodes;
        this.rave = rave;
    }

    public MonteCarlo(Game game, boolean rave) {
        this.game = game;
        this.rave = rave;
    }
