...
public class Hex extends Game {
    ...
    public static void main(String[] args) {
        ...
        MonteCarlo mcts = new MonteCarlo(hex, true);
        System.out.println(mcts.nodes.size());
        MonteCarlo mcts2 = new MonteCarlo(hex, true);
    ...
    public static void saveTreeToFile(Object obj) {
        try {
            FileOutputStream fileOut = new FileOutputStream("mcts3.ser");
    ...
    public List<int[]> getBridges(int[] move) {
        ...
        int maxLength = this.getState().length;
    ...
    public List<int[]> getConnections(int[] a, int[] b) {
        ...
        List<int[]> neighboursA = this.getNeighbours(a);
